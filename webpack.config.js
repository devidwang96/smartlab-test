...
let customBabelConfig = '?' + JSON.stringify({
    "cacheDirectory": true,
    "presets": [
        ["env", {"modules": false, "targets": {"browsers": ["> 2%"], "uglify": true}}]
    ],
...
let plugins = [
    new webpack.DefinePlugin({
        'process.BROWSER': process.env.VUE_ENV == 'client'
    })
...
let rules = [
    {
        ...
        options: {
            loaders: Mix.options.extractVueStyles ? {
                js: 'babel-loader' + customBabelConfig,
...

    {
        ...
        loader: 'babel-loader' + customBabelConfig
    },

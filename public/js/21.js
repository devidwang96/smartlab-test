    ...
    data: function data() {
        return {
            translations: {
                ...
                ru: {
                    pageTitle: 'О нас',
                    pageDescription: '<p>\n' + '                        Мы помогаем ведущим казахстанским компаниям создавать\n' + '                        удивительные приложения, продукты и услуги. Так же за последние 3 года\n' + '                        мы дали возможность многим крошечным веб-стартапам и компаниям\n' + '                        разработать продукты, которые красивы и просты в использовании.\n' + '                    </p> <p>\n' + '                        Мы являемся одним из немногих агенств в Казахстане, которое может\n' + '                        взять идею продукта и реализовать ее от начала до конца. От эскиза\n' + '                        салфетки до реального полномасшатбного проекта. У вас отличная идея\n' + '                        нового продукта, и никто не в силах ее воссоздать? Тогда Мы твои ребята!\n' + '                        Клиенты обращаются к нам на разных этапах жизни продукта. В результате\n' + '                        мы создали разнообразную команду дизайнеров мирового класса, разработчиков\n' + '                        веб-сайтов и мобильных устройств, маркетологов, менеджеров проектов\n' + '                        и специалистов по обеспечению качества, чтобы гарантировать, решение\n' + '                        любой задачи.\n' + '                    </p>',
                    sectionAbout: {
